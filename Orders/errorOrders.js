...
exports.ErrorOrders = class ErrorOrders {
  constructor(page) {
    this.page = page;
    ...
    this.errorOrdersTab = page.getByRole('menuitem', { name: 'Error' }).first();
  }
  ...
  async gotoErrorOrders() {
    await expect(this.errorOrdersTab).toBeVisible();
    await this.errorOrdersTab.click();
    await this.page.waitForLoadState('networkidle');
  ...
  async validateOnlyErrorStatusInMFHColumn() {
    // await expect(this.errorOrdersTab).toBeVisible();
    // await this.errorOrdersTab.click();
    await this.page.waitForLoadState("domcontentloaded");
    await this.page.waitForLoadState("networkidle");
